...
import sample.math.script.TwiceRise;
import sample.math.script.TwiceRiseTest;
...
public class AlgorithmExecutor {
    ...
    private List<String> selfDesignNameList = Lists.newArrayList();

    public AlgorithmExecutor() {
        put("二波", TwiceRise.class);
        put("二波回测", TwiceRiseTest.class);
    }

    private void put(String key, Class groovyClass) {
        cache.put(key, groovyClass);
        selfDesignNameList.add(key);
    }

    public List<String> getSelfDesignNameList() {
        return selfDesignNameList;
    }
